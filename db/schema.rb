...
ActiveRecord::Schema.define(version: 2021_04_11_182918) do
  ...
  create_table "animon_links", force: :cascade do |t|
    t.string "url"
    t.string "title"
    t.bigint "animon_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["animon_id"], name: "index_animon_links_on_animon_id"
  end
  ...
  add_foreign_key "animon_links", "animons"
